...
export default function Page() {
  return (
    <div className="min-h-screen ct-hero-bg flex items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-6xl bg-white rounded-3xl shadow-[var(--shadow-lg)] border border-slate-200/80 overflow-hidden flex flex-col md:flex-row min-h-150">
        ...
        <div className="hidden md:block w-1/2 relative bg-gray-900">
          ...
          >
            <HandHeart className="w-4 h-4 text-[var(--brand)]" />
            <span className="text-sm font-medium text-slate-900">Trust-first crowdfunding</span>
          </motion.div>
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Trust-first crowdfunding: KYC fundraisers, safety-rated campaigns, optional tips
                  only — your gift goes to the cause.
                </p>
              </div>
            </div>
