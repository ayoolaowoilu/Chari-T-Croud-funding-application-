      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed px-2 sm:px-0">
            ...
            want to partner with us, or just want to say hello — our team is ready to help.
          </p>
        </div>
          ...
          <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
            ...
            <div className="p-3 sm:p-4 bg-gray-50 rounded-xl border border-gray-100">
              <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                <span className="font-medium text-gray-900">Response time:</span> We typically respond to all inquiries within 24–48 hours during business days. For urgent matters, please email <a href="mailto:urgent@chari-t.org" className="text-gray-900 font-medium hover:underline">urgent@chari-t.org</a>.
              </p>
            </div>
          </div>
        </div>
