...
const ProfileComponent: React.FC<ProfileProp> = ({ userData, campaigns }) => {
  ...
  const bannerSeed = userData.email ? userData.full_name.replace(/[^a-zA-Z0-9]/g, '') : 'default';
        ...
        <div className="relative px-4">
          ...
          <div className="flex justify-end pt-3 pb-2">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2 border border-gray-300 text-gray-900 text-sm font-bold rounded-full hover:bg-gray-50 transition-colors"
            >
              Contact
            </button>
          </div>
          ...
          <div className="mt-10">
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-bold text-gray-900">{userData.full_name}</h1>
