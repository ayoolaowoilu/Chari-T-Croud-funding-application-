...
const safetyRanks = [
  {
    ...
    description: "Fully verified charity center with complete KYC, bank verification, and registration documents on file.",
  },
  {
    label: "Likely Safe",
    color: "text-blue-600",
    ...
    description: "User campaign with strong engagement signals and no reported issues. Under periodic review.",
  },
  {
    label: "Unsure",
    ...
    description: "New or low-engagement campaign. Limited verification data available. Proceed with caution.",
  },
  {
    label: "Likely Unsafe",
    ...
    description: "Campaign flagged by community reports or algorithmic signals. Under active review by our team.",
  },
  {
    label: "Unsafe",
    color: "text-red-600",
    ...
    description: "Confirmed fraudulent or misleading campaign. Removed from search and donations disabled.",
  },
];
...
const steps = [
  {
    ...
    description: "Find the Start a Cause button on the homepage or navigation menu to begin your campaign journey.",
  },
  {
    number: "02",
    title: "Sign In & Verify Bank",
    description: "You'll be prompted to sign in to your account. New users will need to verify their bank details securely.",
  },
  {
    number: "03",
    title: "Complete KYC",
    description: "Submit your identity verification through our KYC process. This helps us keep the platform safe for everyone.",
  },
  {
    number: "04",
    title: "Create Your Cause",
    description: "Once verified, you can create your campaign. Add details, set a goal, upload images, and tell your story.",
  },
  {
    number: "05",
    title: "Generate & Share",
    description: "Use the Generate Fliers button to create shareable assets, then spread your campaign link far and wide.",
  },
];
...
const centerSteps = [
  ...
  },
  {
    number: "03",
    title: "Add a Center",
    description: "Navigate to Charity Centers and click Add Center to begin the registration process.",
  },
  {
    number: "04",
    title: "Enter Center Details",
    description: "Provide your center's name, mission, location, and operational details in the centers dashboard.",
  },
  {
    number: "05",
    title: "Verify & Register",
    description: "Complete bank verification and submit your registration number for official verification.",
  },
];
      ...
      <main>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 lg:pt-24 pb-10 sm:pb-14 text-center">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Whether you are a donor, a fundraiser, or a charity center, here is everything you need to know about using our platform.
          </p>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          ...
          <div className="mt-6 p-4 sm:p-5 bg-gray-50 rounded-xl border border-gray-100">
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              <span className="font-semibold text-gray-900">Pro tip:</span> After creating your cause, click the{" "}
              <span className="font-medium text-gray-900">Generate Fliers</span> button to automatically create
              shareable promotional materials for your campaign. You will be routed to the flier generator pre-loaded
              with your campaign details. Copy your campaign link and share it anywhere.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-900 rounded-xl flex items-center justify-center mb-4">
                ...
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  Created by verified nonprofit organizations and registered charity centers. These campaigns have
                  completed full bank verification, KYC, and registration checks. They are marked as{" "}
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200">
                ...
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  Created by individual community members. These campaigns are dynamically ranked based on engagement
                  signals, community reports, and verification status. The ranking system helps donors make informed
                  decisions.
                </p>
              </div>
            </div>
        ...
        <section id="ratings" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          <div className="mb-8 sm:mb-10">
            ...
            <p className="text-sm sm:text-base text-gray-600">
              Our automated system ranks user campaigns based on engagement and verification signals so you can donate with confidence.
            </p>
          </div>
        ...
        <section className="bg-gray-50 border-y border-gray-100">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
            ...
            <div className="mt-6 p-4 sm:p-5 bg-white rounded-xl border border-gray-200">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                <span className="font-semibold text-gray-900">Important:</span> Charity centers must provide a valid
                registration number and complete bank verification before they can publish campaigns. This ensures
                donor trust and platform integrity.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            ...
            >
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1">Find Local Charities</h3>
              <p className="text-sm text-gray-600">Discover verified charity centers in your community.</p>
            </a>
            ...
            >
              ...
              <p className="text-sm text-gray-600">Answers to common questions about our platform.</p>
            </a>
