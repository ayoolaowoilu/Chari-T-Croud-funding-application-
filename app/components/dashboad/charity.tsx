    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Button
            variant="secondary"
            size="sm"
            onClick={() => redirect('/dashboard/centers/manage')}
            details="Charity Dashboard"
          />
        ...
        <div className="rounded-lg border border-red-200 bg-red-50 p-6">
          <div className="flex flex-col items-center text-center sm:flex-row sm:text-left">
            ...
            <div className="mt-3 sm:mt-0">
              <h3 className="text-base font-semibold text-red-800">Failed to load centers</h3>
      ...
      {!loading && !loadError && centers.length === 0 && (
        <div className="rounded-lg border border-dashed border-gray-300 bg-white py-16 text-center">
          ...
          <h3 className="mt-4 text-sm font-semibold text-gray-900">No centers found</h3>
          <p className="mt-1 text-sm text-gray-500">
      ...
      {!loading && !loadError && centers.length > 0 && (
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {centers.map((center, index) => {
            const isVerified =
              center.is_verified_status.toLowerCase() === 'verified' ||
              ...
              >
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a
                      ...
                      className="truncate text-sm font-medium text-[var(--brand)] hover:text-[var(--brand-hover)] hover:underline"
                    >
                      {center.website}
                    </a>
                  </div>
                ...
                <div className="mt-4 flex items-center gap-4">
                  <Button
                    ...
                    disabled={!isVerified}
                    onClick={() =>
                      isVerified && redirect(`/dashboard/centers/campaign?id=${center.id}`)
                    }
                  />
                  <Button
                    variant="outline"
