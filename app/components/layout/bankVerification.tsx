  ...
  return (
    <div className="w-screen h-screen fixed left-0 top-0 z-40 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl p-8 shadow-xl w-full max-w-md mx-4">
        <div className="font-bold text-2xl text-black text-center mb-6">Bank Verification</div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {verifiedName && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <div className="text-sm text-green-700">{verifiedName}</div>
            </div>
          )}
          ...
          {submitSuccess && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="text-sm font-medium text-blue-800 mb-1">Success</div>
              <div className="text-sm text-blue-700">Bank details saved successfully!</div>
            </div>
          )}
          ...
          <div className="flex gap-3">
            ...
            {!verifiedName && (
              <button
                type="submit"
                disabled={
                  isLoading || !formData.bankName || (formData.accountNumber as any)?.length < 10
                }
