                ...
                {CATEGORIES.map((cat) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div
                        className={`p-2 rounded-lg ${category === cat.value ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-600 group-hover:bg-slate-200'} transition-colors`}
                      >
                        <svg
                          className="w-5 h-5"
                          fill="none"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
              ...
              {!upload.preview && !upload.url ? (
                ...
                >
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center transition-colors ${dragActive ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
                  >
