...
export default function CenterProfileClient({ centerId, initialCenter, initialError }: Props) {
  ...
  const [_donating, _setDonating] = useState(false);
  ...
  const campaignsMemo = useMemo(() => center?.campaigns || [], [center?.campaigns]);
  ...
  }, [centerId, fetchCenter, initialCenter, initialError]);
    ...
    if (status?.toLowerCase() === 'verified') {
      return (
        <span className="inline-flex items-center" title="Verified Charity">
          <svg
            className="h-4 w-4 text-[#1d9bf0] sm:h-5 sm:w-5"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
  ...
  const randomBanner = center ? `https://picsum.photos/seed/${center.name}-banner/1584/396` : '';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-3 backdrop-blur-sm sm:p-4">
          <div className="relative w-full max-w-sm animate-in fade-in zoom-in-95 overflow-hidden rounded-2xl bg-white shadow-2xl duration-200 sm:max-w-md">
            ...
            <div className="p-4 sm:p-6">
              ...
              <p className="mb-4 line-clamp-3 text-sm leading-relaxed text-gray-600 sm:mb-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-base font-semibold text-gray-500 sm:text-lg">
                    ₦
                  </span>
                  <input
                    type="number"
              ...
              {!isBlind && status == 'unauthenticated' && (
                <div className="animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <p className="mt-1 text-xs text-gray-400">
                    This will be shown publicly on the donation list
                  </p>
                </div>
              )}
              ...
              <PaystackPopup
                ...
                donor_name={
                  isBlind ? null : status == 'authenticated' ? session.user.name : donorName
                }
                id={null}
                owner_id={null}
                message={null}
                    ...
                    {campaigns.map((campaign) => (
                      ...
                      >
                        ...
                        <div className="p-4 sm:p-5">
                          <h3 className="mb-2 line-clamp-1 text-sm font-semibold leading-tight text-gray-900">
                            {campaign.name}
                          </h3>
